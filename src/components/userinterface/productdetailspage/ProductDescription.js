...
export default function ProductDescription({ product, setProduct }) {
  ...
  const fetchAllProductsById = async () => {
    try {
      ...
      console.log('Fetching product details for ID:', product.productid);
      var response = await postData('userinterface/user_display_product_details_by_id', { 
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{
          ...
          <span style={{ marginLeft: 330, display: 'flex' }}>
            ...
            <span style={{ marginLeft: 10 }}><a href={`https://api.whatsapp.com/send?text=${serverURL}${location.pathname}`}><WhatsAppIcon /> </a></span>
          </span>
        </div>
      ...
      return (
        <div onClick={() => handleSelectedProduct(item)} style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ marginTop: 15, width: '100%', height: 50, borderRadius: 20, border: item.productdetailid == productDetailId ? '3px solid #4cd137' : '1px solid #000', padding: 6, display: 'flex', alignItems: 'center' }}>
            <span>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', marginLeft: 10, borderWidth: '.275em', width: 16, height: 16, borderRadius: '50%', border: '1px solid #5B4A76', backgroundColor: '#5B4A76' }}>
                <div style={{ marginLeft: 0.5, borderWidth: '.275em', width: 8, height: 8, borderRadius: '50%', border: '1px solid #5B4A76', backgroundColor: '#fff' }}></div>
              </div>
            </span>
      ...
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        <div style={{ display: 'flex', marginTop: 20 }}>
          ...
          <span style={{
            ...
            {/* <img src="/smart.jpeg" style={{ width: 100, height: 100 }} /> */}
            </span>
    ...
    return (
      <div style={{ display: 'flex', flexDirection: 'column' }}>
        <div style={{ display: 'flex', marginTop: 20, alignItems: 'center' }}>
          ...
          <span style={{
            marginLeft: 10,
          }}><img src="/copy.jpg" style={{ width: 20, height: 20, marginTop: 6 }} /></span>
        </div>
  ...
  return (<div style={{ display: 'flex', flexDirection: 'column' }}>
    <div style={{ marginBottom: 8, marginLeft: 35, }}>
      {showDetail()}
    </div>
